...
-(void)drawRect:(CGRect)rect
{
    ...
    float radius = fmin(rect.size.width/2, rect.size.height/2);
    ...
    UIBezierPath *uiPath = [UIBezierPath bezierPathWithArcCenter: center
                                                          radius: radius
                                                      startAngle: KADegreesToRadians(0)
                                                        endAngle: KADegreesToRadians(360)
                                                       clockwise: YES];
    [uiPath setLineWidth:0.5];
    [uiPath closePath];
    [uiPath fill];
...
-(void)drawProgressLabelCircleInRect:(CGRect)rect
{
    ...
    CGFloat archRadius = (circleRect.size.width) / 2.0 - 1.4;
