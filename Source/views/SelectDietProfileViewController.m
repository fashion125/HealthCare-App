//
//  SelectDietProfileViewController.m
//  Cronometer
//
...
@interface SelectDietProfileViewController ()
@property (readwrite, strong) NSIndexPath* lastIndexPath;
@property (readwrite) int mDietProfileIndex;
@end

@implementation SelectDietProfileViewController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    self.mDietProfileIndex = ((SettingViewController*)self.setting).mDietProfileIndex;
    self.title = @"Select your diet profile";
}
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    return [self.mDietProfiles count];
}
- (UITableViewCell*) tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    NSString* reuseId = @"reuseDietProfile";
    ...
    NSDictionary* dict = (NSDictionary*) [self.mDietProfiles objectAtIndex:indexPath.row];
    [label setText: (NSString*)dict[@"desc"]];
    
    if (self.lastIndexPath==nil) {
        NSInteger irow = indexPath.row;
        if (self.mDietProfileIndex == irow) {
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    ((SettingViewController*)(self.setting)).mDietProfileIndex = (int)(indexPath.row);
